## analyze fragments options

|Tool Suite|Pipeline|Action|
|---|---|---|
|HiFiRe3|analyze|fragments|
...
fragments: align reads to genome, match to RE sites, apply quality filters, scan for chimeras
...
alignment:
  -b,--bandwidth       <string> bandwidth for chaining and base alignment, same as minimap2 -r [platform default] 
